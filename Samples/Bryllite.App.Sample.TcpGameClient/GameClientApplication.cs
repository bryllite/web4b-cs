...
{
    public class GameClientApplication : AppBase
    {
        // game client
        ...
        public GameClientApplication(string[] args) : base(args)
        {
            // server remote url
        ...
        private void OnCommandCoinBalance(string[] args)
        {
            ...
            BConsole.WriteLine(GameClient.UserAddress, "=", Coin.ToCoin(GameClient.GetBalanceAsync().Result), " BRC");
        }
